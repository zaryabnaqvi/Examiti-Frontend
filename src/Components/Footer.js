        ...
        <footer className="text-white">
            <div className="px-8 lg:px-48 py-12 bg-gray-900">
                <div className="flex flex-col md:flex-row gap-8 items-start justify-between">
                    <div className="flex flex-col gap-4">
                        <h2 className="text-2xl font-semibold">EXAMITI</h2>
                        <div className="flex flex-col gap-2 text-gray-400">
                            <p className="w-full lg:w-2/5 text-xs text-justify">
                            Discover the future of exam creation with Examity. 
                            By harnessing the power of AI, we've revolutionized the process, 
                            making it effortless for educational institutes to craft exams with 
                            precision and speed.
                            </p>
                        </div>
                    </div>
            ...
            <div className="flex flex-col items-center lg:items-start lg:flex-row justify-between gap-4 px-8 lg:px-48 py-8 bg-[#101010] font-medium text-xs text-gray-600">
                <div>
                    <p>
                        ...
                        <FontAwesomeIcon icon={faHeart} /> by <span className="font-bold">TechTutors</span>.
                    </p>
                </div>
                <div>{legalLinks}</div>
            </div>
